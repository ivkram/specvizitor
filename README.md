...
For installation instructions, see the [online documentation](https://specvizitor.ivkram.space).

![Specvizitor GUI](https://github.com/ivkram/specvizitor/blob/main/docs/screenshots/specvizitor_gui_showcase.gif)

## Citation

Click [here](https://specvizitor.ivkram.space/citation) to read about how you can acknowledge the use of specvizitor.
