...
#. Interactive data widgets: scroll the mouse wheel to zoom in and zoom out, move the sliders to change the redshift and smooth the data, interact with the colorbar to adjust its range, and more.
