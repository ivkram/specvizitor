...
from .. import QDARKTHEME_VERSION
from .._color import Color
from .._icon.svg import Svg
from .._util import analyze_version_str, get_cash_root_path, get_logger
from ..qtpy import QT_VERSION
from ..qtpy.qt_compat import QT_API
...
def url(color: Color, id: str, rotate: int = 0) -> str:
    ...
    svg_path = get_cash_root_path(QDARKTHEME_VERSION) / f"{id}_{color._to_hex()}_{rotate}.svg"
